	...
	factory: (require) => {
		...
		function SkillsTab({ t, skillsApi }) {
			...
			return h("div", { className: "sm-section" },
				...
				editing !== null ? h(SkillForm, { key: editing, t, skillsApi, name: editing === "new" ? null : editing, snapshot, onSave: onDone, onCancel: () => { setEditing(null); setError(null); } }) : null,
		...
		function SkillForm({ t, skillsApi, name, snapshot, onSave, onCancel }) {
		...
		function McpTab({ t, mcpApi }) {
			...
			return h("div", { className: "sm-section" },
				...
				notice !== null ? h("p", { className: "sm-notice" }, notice) : null,
				error !== null ? h("p", { className: "sm-error", role: "alert" }, error) : null,
				editing !== null ? h(McpForm, { key: editing, t, mcpApi, serverName: editing === "new" ? null : editing, onSave: onDone, onCancel: () => { setEditing(null); setError(null); } }) : null,
		...
		function McpForm({ t, mcpApi, serverName, onSave, onCancel }) {
